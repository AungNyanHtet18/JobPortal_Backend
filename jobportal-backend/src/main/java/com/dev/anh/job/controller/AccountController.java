...
public class AccountController {
	...
	@GetMapping("{id}")
	AccountDetails findAccountById(@PathVariable Long id) {
	...
	@GetMapping("status/accountId/{id}")
	ModificationResult<Boolean> checkRoleStatusById(@PathVariable Long id) {
		 return accountService.checkRoleStatusById(id);
	}
